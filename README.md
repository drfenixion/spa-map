...
# SPA-map is React + Redux app using Google Map API. Display objects on map and filtering them using type and rating filters. Online example - https://drfenixion.github.io/
